//! Example: Implementing a custom Memory backend for MyMolt
//!
...
// ── Re-define the trait types (in your app, import from mymolt::memory) ──
...
async fn main() -> anyhow::Result<()> {
    ...
    println!("🧠 MyMolt Memory Demo — InMemoryBackend\n");
